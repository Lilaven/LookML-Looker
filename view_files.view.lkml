...
link: { label: "ONE Force Case Details"
  ...
  dimension: open_to_lst_rslv_half_hol_mid_1 { 
    ...
    type: number
    sql: CASE WHEN ${dmc_crm_bh_hol_start.hol_st_dt_raw} < ${dmc_crm_bh_hol_start.day_st_dt_raw}
  ...
  dimension: open_to_lst_rslv_half_hol_start { 
    ...
    type: number
    sql: CASE WHEN ${cre_dt_lc_raw} <= ${dmc_crm_bh_hol_start.hol_st_dt_raw}
  ...
  dimension: open_to_lst_rslv_half_hol_end { 
    ...
    type: number
    sql: CASE WHEN ${cs_rslvd_dt_tm_lc_raw} <= ${dmc_crm_bh_hol_end.hol_st_dt_raw}
  ...
  dimension: dur_of_open_to_lst_rslv_days { 
    ...
    type: number
    sql: CASE WHEN ${cre_dt_lc_date} IS NULL THEN NULL
  ...
  dimension: n1st_res_lst_rspn_half_hol_mid_1 { 
    ...
    type: number
    sql: CASE WHEN ${dmc_crm_bh_hol_n1st_res_lst_rspn_st.hol_st_dt_raw} < ${dmc_crm_bh_hol_n1st_res_lst_rspn_st.day_st_dt_raw}
  ...
  dimension: n1st_res_lst_rspn_half_hol_start { 
    ...
    type: number
    sql: CASE WHEN ${n1st_res_lst_rspn_sdur_dt_raw} <= ${dmc_crm_bh_hol_n1st_res_lst_rspn_st.hol_st_dt_raw}
  ...
  dimension: n1st_res_lst_rspn_half_hol_end { 
    ...
    type: number
    sql: CASE WHEN ${n1st_res_lst_rspn_edur_dt_raw} <= ${dmc_crm_bh_hol_n1st_res_lst_rspn_ed.hol_st_dt_raw}
  ...
  dimension: rspn_flg_trakr_lst_rspn_half_hol_mid_1 { 
    ...
    type: number
    sql: CASE WHEN ${dmc_crm_bh_hol_rspn_flg_trakr_lst_rspn_st.hol_st_dt_raw} < ${dmc_crm_bh_hol_rspn_flg_trakr_lst_rspn_st.day_st_dt_raw}
  ...
  dimension: rspn_flg_trakr_lst_rspn_half_hol_start { 
    ...
    type: number
    sql: CASE WHEN ${rspn_flg_trakr_lst_rspn_sdur_dt_raw} <= ${dmc_crm_bh_hol_rspn_flg_trakr_lst_rspn_st.hol_st_dt_raw}
  ...
  dimension: rspn_flg_trakr_lst_rspn_half_hol_end { 
    ...
    type: number
    sql: CASE WHEN ${rspn_flg_trakr_lst_rspn_edur_dt_raw} <= ${dmc_crm_bh_hol_rspn_flg_trakr_lst_rspn_ed.hol_st_dt_raw}
  ...
  dimension: cre_cs_in_prog_half_hol_mid_1 { 
    ...
    type: number
    sql: CASE WHEN ${dmc_crm_bh_hol_cre_cs_in_prog_st.hol_st_dt_raw} < ${dmc_crm_bh_hol_cre_cs_in_prog_st.day_st_dt_raw}
  ...
  dimension: cre_cs_in_prog_half_hol_start { 
    ...
    type: number
    sql: CASE WHEN ${cre_cs_in_prog_sdur_dt_raw} <= ${dmc_crm_bh_hol_cre_cs_in_prog_st.hol_st_dt_raw}
  ...
  dimension: cre_cs_in_prog_half_hol_end { 
    ...
    type: number
    sql: CASE WHEN ${cre_cs_in_prog_edur_dt_raw} <= ${dmc_crm_bh_hol_cre_cs_in_prog_ed.hol_st_dt_raw}
  ...
  dimension: cs_in_prog_n1st_res_half_hol_mid_1 { 
    ...
    type: number
    sql: CASE WHEN ${dmc_crm_bh_hol_cs_in_prog_n1st_res_st.hol_st_dt_raw} < ${dmc_crm_bh_hol_cs_in_prog_n1st_res_st.day_st_dt_raw}
  ...
  dimension: cs_in_prog_n1st_res_half_hol_start { 
    ...
    type: number
    sql: CASE WHEN ${cs_in_prog_n1st_res_sdur_dt_raw} <= ${dmc_crm_bh_hol_cs_in_prog_n1st_res_st.hol_st_dt_raw}
  ...
  dimension: cs_in_prog_n1st_res_half_hol_end { 
    ...
    type: number
    sql: CASE WHEN ${cs_in_prog_n1st_res_edur_dt_raw} <= ${dmc_crm_bh_hol_cs_in_prog_n1st_res_ed.hol_st_dt_raw}
  ...
  dimension: cs_rslvd_cls_half_hol_mid_1 { 
    ...
    type: number
    sql: CASE WHEN ${dmc_crm_bh_hol_cs_rslvd_cls_st.hol_st_dt_raw} < ${dmc_crm_bh_hol_cs_rslvd_cls_st.day_st_dt_raw}
  ...
  dimension: cs_rslvd_cls_half_hol_start { 
    ...
    type: number
    sql: CASE WHEN ${cs_rslvd_cls_sdur_dt_raw} <= ${dmc_crm_bh_hol_cs_rslvd_cls_st.hol_st_dt_raw}
  ...
  dimension: cs_rslvd_cls_half_hol_end { 
    ...
    type: number
    sql: CASE WHEN ${cs_rslvd_cls_edur_dt_raw} <= ${dmc_crm_bh_hol_cs_rslvd_cls_ed.hol_st_dt_raw}
  ...
  dimension: frst_cls_frst_reop_half_hol_mid_1 { 
    ...
    type: number
    sql: CASE WHEN ${dmc_crm_bh_hol_frst_cls_frst_reop_st.hol_st_dt_raw} < ${dmc_crm_bh_hol_frst_cls_frst_reop_st.day_st_dt_raw}
  ...
  dimension: frst_cls_frst_reop_half_hol_start { 
    ...
    type: number
    sql: CASE WHEN ${frst_cls_frst_reop_sdur_dt_raw} <= ${dmc_crm_bh_hol_frst_cls_frst_reop_st.hol_st_dt_raw}
  ...
  dimension: frst_cls_frst_reop_half_hol_end { 
    ...
    type: number
    sql: CASE WHEN ${frst_cls_frst_reop_edur_dt_raw} <= ${dmc_crm_bh_hol_frst_cls_frst_reop_ed.hol_st_dt_raw}
  ...
  dimension: cs_wht_cust_entered { 
    ...
    type: string
    description: "None, Both, Service or Contract"
  ...
  dimension: cs_res_func { 
    ...
    group_item_label: "Case Responsible Function"
  ...
  dimension_group: cre_dt_lc { 
    ...
    datatype: datetime
    convert_tz: no
    description: "Open Date in Local Time Zone"
  }
  ...
  dimension_group: cls_dt_utc { 
    ...
    datatype: datetime
    convert_tz: no
    description: "Closed Date in UTC"
  }
  ...
  dimension_group: cls_dt_lc { 
    ...
    datatype: datetime
    convert_tz: no
    description: "Closed Date in Local Time Zone"
  }
  ...
  dimension_group: cs_rslvd_dt_adj { 
    hidden: yes
    type: time
    timeframes: [ raw, time, hour_of_day, date, week_of_year, month_num, quarter_of_year, year, fiscal_quarter_of_year, fiscal_year, ] 
    datatype: datetime
    convert_tz: no
  ...
  dimension_group: cs_rslvd_dt_tm_utc { 
    ...
    datatype: datetime
    convert_tz: no
    description: "Resolved Date in UTC"
  }
  ...
  dimension_group: cs_rslvd_dt_tm_lc { 
    ...
    group_item_label: "@{time_frames}"
    label: "Case Resolved Time (Local)"
    type: time
    timeframes: 
	[raw,
	time,
  ...
  dimension_group: n1st_res_lst_rspn_sdur_dt { 
    ...
    type: time
    timeframes: [ raw, time, hour_of_day, date, day_of_week, week_of_year, month_num, quarter_of_year, fiscal_quarter_of_year, year, fiscal_year, ] 
    datatype: datetime
    convert_tz: no
  ...
  WHEN ${cs_hdl_tm_min} > ${dmo_svc_kpi_trgts_aht.kpi_val} THEN 0 ELSE NULL END ;;
    filters__all: [ [ { cs_ori: Web,Chat
   } { cs_hdl_tm_min: NOT NULL
   } ]  ] 
  ...
  WHEN ${avg_chat_n1st_res_tm_min} > ${dmo_svc_kpi_trgts_frt.kpi_val} THEN 0 ELSE NULL END ;;
    filters__all: [ [ { cs_ori: Web,Chat
   } { avg_chat_n1st_res_tm_min: NOT NULL
   } ]  ] 
    value_format_name: percent_0
  }
  ...
  measure: abdn_cases { 
    ...
    type: count_distinct
    sql: ${cs_no} ;;
    filters__all: [ [ { cs_ori: Chat
   } { resln_rsn_nw: Customer Abandoned Chat
   } ]  ] 
  }
...
view: dmc_period_agn_lst_msg_ldt {
  ...
  dimension: iso_yrwk_desc { 
    ...
    group_item_label: "11. Week of Year (YYYY/WW)"
    label: "Customer's Last Chat Message Datetime Local Week of Year (YYYY/WW)"
  }
  ...
  dimension: yrmon_desc { 
    ...
    group_label: "Customer's Last Chat Message Datetime (Local)"
    group_item_label: "12. Month (YYYY/MM)"
    label: "Customer's Last Chat Message Datetime Local Month (YYYY/MM)"
  }
  ...
  dimension: yrqtr_desc { 
    ...
    group_label: "Customer's Last Chat Message Datetime (Local)"
    group_item_label: "13. Calendar Quarter (YYYY/QQ)"
    label: "Customer's Last Chat Message Datetime Local Calendar Quarter (YYYY/QQ)"
  }
  ...
  dimension: accqtr_desc { 
    ...
    group_label: "Customer's Last Chat Message Datetime (Local)"
    group_item_label: "14. Fiscal Quarter (YYYY/QQ)"
    label: "Customer's Last Chat Message Datetime Local Fiscal Quarter (YYYY/QQ)"
  }
...
view: dmc_period_agn_lst_msg_gdt {
  ...
  dimension: iso_yrwk_desc { 
    ...
    group_item_label: "11. Week of Year (YYYY/WW)"
    label: "Customer's Last Chat Message Datetime UTC Week of Year (YYYY/WW)"
  }
  ...
  dimension: yrmon_desc { 
    ...
    group_label: "Customer's Last Chat Message Datetime (UTC)"
    group_item_label: "12. Month (YYYY/MM)"
    label: "Customer's Last Chat Message Datetime UTC Month (YYYY/MM)"
  }
  ...
  dimension: yrqtr_desc { 
    ...
    group_label: "Customer's Last Chat Message Datetime (UTC)"
    group_item_label: "13. Calendar Quarter (YYYY/QQ)"
    label: "Customer's Last Chat Message Datetime UTC Calendar Quarter (YYYY/QQ)"
  }
  ...
  dimension: accqtr_desc { 
    ...
    group_label: "Customer's Last Chat Message Datetime (UTC)"
    group_item_label: "14. Fiscal Quarter (YYYY/QQ)"
    label: "Customer's Last Chat Message Datetime UTC Fiscal Quarter (YYYY/QQ)"
  }
...
view: dmo_case_his_owner_cnt {
  derived_table: { sql: WITH SUB_CS_HIS AS
...
view: dmo_chat_tc_ext_epx {
  ...
  dimension: chat_svey_cmt { 
    view_label: "Chat Transcript Info"
    group_label: "General"
    group_item_label: "Chat Survey Comment"
  ...
  dimension_group: agn_lst_msg_ldt { 
    ...
    group_item_label: "@{time_frames}"
    label: "Agent's Last Chat Messagetime Local"
    type: time
    timeframes: 
	[raw,
	time,
  ...
  dimension_group: agn_lst_msg_gdt { 
    ...
    group_item_label: "@{time_frames}"
    label: "Agent's Last Chat Messagetime UTC"
    type: time
    timeframes: 
	[raw,
	time,
  ...
  dimension_group: cust_lst_msg_ldt { 
    ...
    group_label: "Customer's Last Chat Message Datetime (Local)"
    group_item_label: "@{time_frames}"
    label: "Customer's Last Chat Messagetime Local"
    type: time
    timeframes: 
	[raw,
	time,
  ...
  dimension_group: cust_lst_msg_gdt { 
    ...
    group_label: "Customer's Last Chat Message Datetime (UTC)"
    group_item_label: "@{time_frames}"
    label: "Customer's Last Chat Messagetime UTC"
    type: time
    timeframes: 
	[raw,
	time,
  ...
  measure: count_of_abdn_ct_cs { 
    ...
    filters__all: [ [ { ct_end_rs_grp: Abandoned
   } ]  ] 
  }
  ...
  measure: count_of_ct_cs { 
    ...
    type: count_distinct
    sql: ${dmo_case_v_ext_epx.cs_no} ;;
    filters__all: [ [ { dmo_case_v_ext_epx.cs_ori: Chat
   } ]  ] 
  }
...
view: dmo_case_trns_n_escl_lst_trns_ct {
  derived_table: { sql: SELECT CS_ID, MAX(TRNS_N_ESCL_DT_TM) LST_TRNS_DT
...
view: dmo_1st_case_trns_his_epx {
  extends__all: [ [ dmo_1st_case_trns_his, ]  ]
  dimension: trns_tp { 
    hidden: no
  ...
  dimension_group: trns_dt_tm_utc { 
    ...
    datatype: datetime
    convert_tz: no
    description: "Transfer Date in UTC"
  }
