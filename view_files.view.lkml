...
view: of_dep_sched_smry {
 ...
 allowed_value: { label: "No"
  ...
  measure: c_loader { 
    ...
    type: count
    filters__all: [ [ { is_loader: Yes } { schedule_status: Scheduled }] ] 
    drill_fields: [ ]  }
  measure: c_phaseout { 
    label: "No of Phaseout Sailing"
    type: count
    filters__all: [ [ { schedule_status: No Schedule }] ] 
    drill_fields: [ ]  }
  measure: c_sailing {   label: "No of Total Sailing"
    type: count }
  measure: c_scheduled { 
    label: "No of Scheduled Sailing"
    type: count
    filters__all: [ [ { schedule_status: Scheduled }] ] 
    drill_fields: [ ]  }
  ...
  measure: c_void { 
    ...
    type: count
    filters__all: [ [ { schedule_status: Void }] ] 
    drill_fields: [ ]  }
  ...
  measure: sched_target { 
    ...
    type: number
    sql: {% if show_or_hide_vms_target._parameter_value == "'Show'" %}
...
view: of_dep_sched_smry2 {
 ...
 allowed_value: { label: "No"
  ...
  measure: c_loader_till_last_cmpl_wk { 
    type: count
    filters__all: [ [ { is_loader: Yes } { schedule_status: Scheduled } { of_sales_week_master.is_till_last_cmpl_wk: yes }] ] 
    drill_fields: [ ]  }
  measure: c_phaseout { 
    label: "No of Phaseout Sailing"
    type: count
  ...
  measure: c_scheduled_till_last_cmpl_wk { 
    type: count
    filters__all: [ [ { schedule_status: Scheduled } { of_sales_week_master.is_till_last_cmpl_wk: yes }] ] 
    drill_fields: [ ]  }
  measure: c_scheduled_wo_ldr { 
    label: "No of Scheduled without Loader"
    type: number
  ...
  measure: c_void_till_last_cmpl_wk { 
    type: count
    filters__all: [ [ { schedule_status: Void } { of_sales_week_master.is_till_last_cmpl_wk: yes }] ] 
    drill_fields: [ ]  }
  measure: c_void_wo_ldr { 
    label: "No of Void Sailing without Loader"
    type: number
    sql: CASE
        ...
        ELSE ${c_void}
      END ;; }
  measure: c_void_wo_ldr_till_last_cmpl_wk {   type: number
    sql: CASE
...
view: of_plan_week {
  derived_table: { sql: select sales_week from ONEFORCE.OF_PLAN_WEEK
  union all
...
view: of_vms_smry {
  ...
  dimension: record_id {   type: string
    sql: ${TABLE}.Record_Id ;; }
  dimension: sales_week {   type: string
    sql: ${TABLE}.Sales_Week ;; }
  dimension: schedule_status {   type: string
    sql: ${TABLE}.Schedule_Status ;; }
  dimension: service_lane {   type: string
    sql: ${TABLE}.Service_Lane ;; }
  
  measure: count {   type: count
    drill_fields: [ ]  }
  measure: schedule_id {   type: list
    list_field: schedule_status }
  }


view: first_case_transfer_history {
  derived_table: { sql: SELECT *EXCEPT(RowNumber) FROM
      (SELECT DISTINCT
...
view: tender_contract_current {
  derived_table: { sql: select 'CURR' as record_type, PARSE_DATE("%m/%d/%Y",a.report_dt) report_dt,
  ...
  measure: count { 
    ...
    set: detail { fields: [ report_dt, cust_grp_nm, cust_grp_id, tender_nm, svc_cont_no, cont_start_dt, cont_end_dt,]  }}


view: tender_contract_previous {
  derived_table: { sql: select 'PREV' as record_type, PARSE_DATE("%m/%d/%Y",c.report_dt) report_dt,
  g.cust_grp_nm,
  c.cust_grp_id,
  c.tender_nm,
  c.ckam,
...
view: bkg_cncl_reason {
  derived_table: { sql: SELECT 'Sales Guidance' as cancel_reason, 'S' as code, 'CANCEL REASON : SALES GUIDANCE' as cancel_reason_raw, 'ONE' as category, 'Yes' as reason_category, 'Cancel Reason has been deactivated' as cancel_reason_def
      UNION ALL
      ...
      UNION ALL
      SELECT 'Missing Approval'
  as cancel_reason, 'U' as code, '' as cancel_reason_raw, 'ONE'      as category, 'Yes' as reason_category,'Missing Approval'
  as cancel_reason_def
      UNION ALL
      SELECT 'ONE QUOTE'
  as cancel_reason, 'K' as code, '' as cancel_reason_raw, 'Customer' as category, 'Yes' as reason_category,'ONE QUOTE'
  as cancel_reason_def
      UNION ALL
  ...
  dimension: cancel_reason {   type: string
    sql: ${TABLE}.cancel_reason ;; }
  dimension: cancel_reason_def {   type: string
    sql: ${TABLE}.cancel_reason_def ;; }
  dimension: cancel_reason_raw {   type: string
  ...
  dimension: code { 
    ...
    type: string
    sql: ${TABLE}.code ;; }
  dimension: reason_category {   type: string
  ...
  measure: count { 
    ...
    set: detail { fields: [ cancel_reason, code, cancel_reason_raw, cancel_reason_def, category, reason_category,]  }}


view: bkg_cxl_sub_rsn {
  derived_table: { sql: SELECT 'C1'  as bkg_cxl_sub_rsn_cd , 'Customer Circumstance: Cargo Readiness/Availability/Quality'  as bkg_cxl_sub_rsn_desc UNION ALL
  ...
  dimension: bkg_cxl_sub_rsn_cd {   type: string
    sql: ${TABLE}.bkg_cxl_sub_rsn_cd ;; }
  dimension: bkg_cxl_sub_rsn_desc {   type: string
    sql: ${TABLE}.bkg_cxl_sub_rsn_desc ;; }
  
  measure: count {   type: count
    drill_fields: [ detail*,]  }
  
    set: detail { fields: [ bkg_cxl_sub_rsn_cd, bkg_cxl_sub_rsn_desc,]  }}


view: ckam_mapping_one_per_country {
  derived_table: { sql: SELECT Customer_Group        as customer_grp_oneforce_id,
  cust_grp_id
  as customer_grp_id,
  Sales_Person
  as ckam_sales_person,
...
FROM (
  ...
  dimension: ckam_sales_person {   type: string
    sql: ${TABLE}.ckam_sales_person ;; }
  dimension: contract_country_code {   type: string
    sql: ${TABLE}.contract_country_code ;; }
  dimension: contract_country_name {   type: string
    sql: ${TABLE}.contract_country_name ;; }
  dimension: customer_grp_id {   type: string
    sql: ${TABLE}.customer_grp_id ;; }
  dimension: customer_grp_oneforce_id {   type: string
...
FROM (
  ...
  dimension: contract_country_name {   type: string
    sql: ${TABLE}.contract_country_name ;; }
  dimension: contract_office_code {   type: string
...
view: cust_priority_list {
  derived_table: { sql: select  distinct a.cust_cd,
  a.cust_grp_id,
  g.key_Acct_tp_cd,
  fy_teu.fiscal_year,
  fy_teu.teu
  ...
  measure: count_cust_cd { 
    ...
    set: detail { fields: [ cust_cd, cust_grp_id, key_acct_tp_cd, teu,]  }}
...
view: of_user_duplicate_cust_grp {
  ...
  dimension: office_code_new {   type: string
...
view: duplicate_cust_grp {
  derived_table: { sql: WITH dup_grp_idx_list AS (
  ...
  as cust_grp_cnt
  ,
      l.cust_grp_cnt_active
  as cust_grp_cnt_active
  ,
      l.vld_retn_identified
  as vld_retn_identified
  ,
      l.inconsistent_acct_typ         as inconsistent_acct_typ         ,
      l.cust_grp_id_lst
  as cust_grp_id_lst
  ,
      l.matching_condition
  as matching_condition
  ,
  ...
  ,
      g.active_flg
  as cust_grp_active_flg        ,
      g.vld_retn_flg
  as cust_grp_vld_retn_flg      ,
      g.key_acct_tp_cd
  as key_acct_tp_cd
  ,
      g.for_ref_rhq
  as cust_grp_for_ref_rhq       ,
      g.pic_email
  as cust_grp_pic_email         ,
      g.pic_fullname
  as cust_grp_pic_fullname      ,
      g.gam_usr_id
  as gam_usr_id
  ,
      gam_usr.email
  ...
  ,
      c.active_flg
  as child_cust_active_flg       ,
      c.to_be_cust_cd
  as child_cust_to_be_cust_cd    ,
      c.is_contract_cust
  as child_cust_is_contract      ,
      c.poten_dup_flg
  as child_cust_poten_dup_flg    ,
      c.vld_retn_flg
  as child_cust_vld_rtn_flg      ,
      c.ofc_type
  as child_cust_off_type         ,
      c.ofc_type_order
  as child_cust_off_type_order   ,
      c.cust_owner_id
  as child_cust_owner_id         ,
      c.top_child_rhq
  as child_cust_top_child_rhq    ,
      b.teu
  as child_cust_teu
  ...
  parameter: dup_set_count_dimension_param { 
    ...
    type: string
    allowed_value: { value: "RHQ"
  label: "RHQ" }
 allowed_value: { value: "CTRY"
  label: "Country" }
 allowed_value: { value: "OFC"
  label: "Office" }
    default_value: "RHQ" }
  ...
  dimension: dup_set_count_dimension { 
    ...
    sql: {% if dup_set_count_dimension_param._parameter_value == "'RHQ'" %}
        ${dup_grp_for_ref_rhq}
...
view: equipment_category {
  derived_table: { sql: SELECT '20ST'  as equipment_type_abbreviation, 'D2' as equipment_type_size, 'Dry Van' as equipment_category
      UNION ALL
...
view: gam_mapping {
  ...
  Sales_Person         as gam_usr_id,
    FROM (
      ...
      INNER JOIN `ONEFORCE.OF_USER`
  u on (s.Sales_Person   = u.ONEForce_ID)
  ...
  dimension: customer_grp_oneforce_id {   type: string
    sql: ${TABLE}.customer_grp_oneforce_id ;; }
  dimension: gam_usr_id {   type: string
    sql: ${TABLE}.gam_usr_id ;; }
  set: detail { fields: [ customer_grp_oneforce_id, customer_grp_id, gam_usr_id,]  }}


view: global_cva_completion {
  derived_table: { sql: select v.cust_cd, v.name as customer_name,
  ...
  parameter: show_percent {   allowed_value: { label: "Yes"
  value: "Yes" }
 allowed_value: { label: "No"
  value: "No" }
    default_value: "No" }
  filter: date_filter { 
    ...
    default_value: "today"
    convert_tz: yes }
  dimension: ctrt_exp_diff {   type: string
    sql: CASE WHEN ${record_type} = 'QualCVA' THEN
      CASE
    ...
    ELSE
      'Not Qualified'
    END ;; }
  dimension: ctrt_exp_mtrx {   type: string
    sql: CASE WHEN ${record_type} = 'QualCVA' THEN
      CASE
      WHEN ${cva_exp_date_diff_raw} IS NULL THEN 'Error'
      WHEN ${cva_exp_date_diff_raw} < 0  THEN 'Expired'
    ...
    ELSE
      ...
      END
    END ;; }
  dimension: ctrt_period_tp_cd {   type: string
    sql: ${TABLE}.ctrt_period_tp_cd ;; }
  dimension: cust_cd {   type: string
    sql: ${TABLE}.cust_cd ;; }
  dimension: cust_grp_hrchy_cd {   type: string
  ...
  dimension: cva_name {   type: string
    sql: ${TABLE}.cva_name ;; }
  ...
  dimension: cva_target { 
    ...
    value_format_name: decimal_0 }
  dimension: destination {   type: string
    sql: ${TABLE}.destination ;; }
  dimension: direction {   type: string
    sql: ${TABLE}.direction ;; }
  dimension: end_month { 
    type: date
    datatype: date
  ...
  dimension: gam_name { 
    ...
    sql: ${TABLE}.gam_name ;; }
  dimension: group_code {   type: string
    sql: ${TABLE}.cust_grp_id ;; }
  dimension: group_name {   type: string
    sql: ${TABLE}.cust_grp_nm ;; }
  ...
  dimension: nvo_bco_flag {   type: string
    sql: ${TABLE}.nvo_bco_flag ;; }
  dimension: origin {   type: string
    sql: ${TABLE}.origin ;; }
  dimension: origin_country {   type: string
    sql: ${TABLE}.origin_country ;; }
  dimension: ram_name { 
    type: string
    description: "Sales Person in CVA"
    sql: ${TABLE}.cva_ram ;; }
  dimension: record_type {   type: string
    sql: ${TABLE}.record_type ;; }
  dimension: sc_rfa_no {   type: string
    sql: ${TABLE}.sc_rfa_no ;; }
  dimension: service_lane {   type: string
    sql: ${TABLE}.service_lane ;; }
  dimension: service_scope {   type: string
    sql: ${TABLE}.service_scope ;; }
  dimension: service_scope_group {   type: string
    sql: ${TABLE}.service_scope_group ;; }
  dimension: start_month { 
    type: date
    datatype: date
    sql: ${TABLE}.start_month ;; }
  dimension: syear {   type: string
    sql: ${TABLE}.syear ;; }
  ...
  measure: bco_comp { 
    type: count_distinct
    sql: ${cust_cd} ;;
    filters__all: [ [ { nvo_bco_flag: BCO, NVO }] ] 
  ...
  measure: with_CVA_count { 
    ...
    filters__all: [ [ { record_type: QualCVA }] ] 
    
link: { label: "By Customer"
...
link: { label: "BCO-NVO"
  url: "{{bco_comp._link}}" }
link: { label: "Completion by GAM"
  url: "{{ bco_nvo_w._link }}" }
link: { label: "Customer & Volume Agreement Details"
...
link: { label: "By CVA"
  ...
  measure: without_CVA_count { 
    ...
    filters__all: [ [ { record_type: -QualCVA } { cust_cd: -null }] ] 
    
link: { label: "By Customer"
  url: "{{ without_CVA_count._link }}" }
link: { label: "By Volume Agreement"
...
link: { label: "By Volume Agreement"
  ...
  measure: without_CVA_perc { 
    ...
    set: detail_w { fields: [ group_code, group_name, cust_cd, customer_name, nvo_bco_flag, cust_grp_hrchy_cd_dscr, gam_name, syear, cva_name, start_month, end_month, service_scope_group, service_scope, direction, origin_country, origin, destination, cva_target, customer_target,]  }
    set: detail_wo { fields: [ group_code, group_name, cust_cd, customer_name, nvo_bco_flag, cust_grp_hrchy_cd_dscr, gam_name, syear, cva_name, latest_start_month, latest_end_month, sc_rfa_no, ctrt_period_tp_cd, service_scope_group, service_scope, service_lane, direction, origin, origin_country, destination, cva_target, customer_target,]  }
    set: cust_detail_w { fields: [ group_code, group_name, cust_cd, customer_name, nvo_bco_flag, cust_grp_hrchy_cd_dscr, gam_name,]  }
    set: cust_detail_wo { fields: [ group_code, group_name, cust_cd, customer_name, nvo_bco_flag, cust_grp_hrchy_cd_dscr, gam_name, latest_start_month, latest_end_month, sc_rfa_no, ctrt_period_tp_cd,]  }}


view: global_cva_completion_2_1 {
  derived_table: { sql: SELECT
  ...
  parameter: calendar_selection { 
    ...
    type: string
    allowed_value: { value: "CALENDAR"
  label: "Calendar" }
 allowed_value: { value: "FISCAL"
  label: "Fiscal" }
  ...
  parameter: param_cust_grping_option { 
    ...
    type: string
    allowed_value: { label: "By Customer Group"
  value: "CUST_GRP" }
 allowed_value: { label: "By Customer Code"
  value: "CUST_CD" }
    default_value: "CUST_CD" }
  parameter: param_cust_percent_partition { 
    type: string
    allowed_value: { label: "By Dummy Val"
  value: "DUMMY" }
 allowed_value: { label: "By Key Account"
  value: "KEY_ACC" }
 allowed_value: { label: "By Dominant Flag"
  value: "DOM_FLG" }
    default_value: "DUMMY" }
  parameter: param_drill_option { 
    type: string
    allowed_value: { label: "Overall"
  value: "OVERALL" }
 allowed_value: { label: "By Dom Flag"
  value: "DOM" }
 allowed_value: { label: "By Trade Group"
  value: "TRD_GRP" }
 allowed_value: { label: "By Svc Scp Grp"
  value: "SSG_GRP" }
 allowed_value: { label: "By Contract RHQ"
  value: "CTRT_RHQ" }
 allowed_value: { label: "By Contract Country"
  value: "CTRT_CTRY" }
 allowed_value: { label: "By Contract Office"
  value: "CTRT_OFC" }
 allowed_value: { label: "By CKAM"
  value: "CKAM" }
 allowed_value: { label: "By Contract Length"
  value: "CTRT_LEN" }
 allowed_value: { label: "By Month"
  value: "MTH" }
    default_value: "OVERALL" }
  parameter: param_dynamic_dim_1 { 
    type: string
    allowed_value: { label: "By Service Scope Code"
  value: "SSCP_CODE" }
 allowed_value: { label: "By Contract Office"
  value: "CTRT_OFC" }
 allowed_value: { label: "By Contract Country"
 ...
 allowed_value: { label: "By CKAM"
  ...
  parameter: param_gka_nvo_option { 
    type: string
    allowed_value: { value: "SSG_DOM"
  label: "By SSG & DOM" }
 allowed_value: { value: "SVC_SCP"
  label: "By Service Scope" }
  ...
  dimension: cust_cd { 
    ...
    type: string
    sql: ${TABLE}.cust_cd ;; }
  dimension: cust_cd_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_grp_sts ;; }
  dimension: cust_cd_n_ckam_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ckam_grp_sts ;; }
  dimension: cust_cd_n_ckam_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_n_ckam_grp_sts_multimth ;; }
  dimension: cust_cd_n_ctrtctry_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtctry_grp_sts ;; }
  dimension: cust_cd_n_ctrtctry_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtctry_grp_sts_multimth ;; }
  dimension: cust_cd_n_ctrtofc_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtofc_grp_sts ;; }
  dimension: cust_cd_n_ctrtofc_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtofc_grp_sts_multimth ;; }
  dimension: cust_cd_n_ctrtrhq_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtrhq_grp_sts ;; }
  dimension: cust_cd_n_ctrtrhq_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtrhq_grp_sts_multimth ;; }
  dimension: cust_cd_n_dom_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_dom_grp_sts ;; }
  dimension: cust_cd_n_dom_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_n_dom_grp_sts_multimth ;; }
  dimension: cust_cd_n_nm { 
    type: string
    sql: ${TABLE}.cust_cd_n_nm ;;
    suggest_persist_for: "4 hours" }
  dimension: cust_cd_n_period_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_n_period_grp_sts_multimth ;; }
  dimension: cust_cd_n_sscp_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_n_sscp_grp_sts_multimth ;; }
  dimension: cust_cd_n_ssg_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ssg_grp_sts ;; }
  dimension: cust_cd_n_ssg_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_n_ssg_grp_sts_multimth ;; }
  dimension: cust_cd_n_trd_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_trd_grp_sts ;; }
  dimension: cust_cd_n_trd_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_n_trd_grp_sts_multimth ;; }
  dimension: cust_cd_sts_multimth {   type: string
    sql: ${TABLE}.cust_cd_sts_multimth ;; }
  dimension: cust_grp_grp_sts {   type: string
  ...
  dimension: cust_grp_id_n_nm { 
    ...
    suggest_persist_for: "4 hours" }
  dimension: cust_grp_n_ckam_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ckam_grp_sts ;; }
  dimension: cust_grp_n_ckam_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_n_ckam_grp_sts_multimth ;; }
  dimension: cust_grp_n_ctrtctry_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtctry_grp_sts ;; }
  dimension: cust_grp_n_ctrtctry_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtctry_grp_sts_multimth ;; }
  dimension: cust_grp_n_ctrtofc_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtofc_grp_sts ;; }
  dimension: cust_grp_n_ctrtofc_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtofc_grp_sts_multimth ;; }
  dimension: cust_grp_n_ctrtrhq_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtrhq_grp_sts ;; }
  dimension: cust_grp_n_ctrtrhq_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtrhq_grp_sts_multimth ;; }
  dimension: cust_grp_n_dom_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_dom_grp_sts ;; }
  dimension: cust_grp_n_dom_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_n_dom_grp_sts_multimth ;; }
  dimension: cust_grp_n_period_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_n_period_grp_sts_multimth ;; }
  dimension: cust_grp_n_sscp_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_n_sscp_grp_sts_multimth ;; }
  dimension: cust_grp_n_ssg_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ssg_grp_sts ;; }
  dimension: cust_grp_n_ssg_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_n_ssg_grp_sts_multimth ;; }
  dimension: cust_grp_n_trd_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_trd_grp_sts ;; }
  dimension: cust_grp_n_trd_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_n_trd_grp_sts_multimth ;; }
  dimension: cust_grp_sts_multimth {   type: string
    sql: ${TABLE}.cust_grp_sts_multimth ;; }
  dimension: cust_grp_typ {   type: string
  ...
  dimension: dynamic_dim_1 { 
    ...
    type: string
    sql: {% if     param_dynamic_dim_1._parameter_value == "'SSCP_CODE'"  %} ${gka_nvo_svc_scp_cd}
  ...
  dimension: dynamic_dim_2 { 
    ...
    type: string
    sql: {% if     param_dynamic_dim_2._parameter_value == "'SSCP_CODE'"  %} ${gka_nvo_svc_scp_cd}
  ...
  dimension: dynamic_dim_3 { 
    ...
    type: string
    sql: {% if     param_dynamic_dim_3._parameter_value == "'SSCP_CODE'"  %} ${gka_nvo_svc_scp_cd}
        ...
        {% endif %} ;; }
  dimension: dynamic_dim_pivot_1 {   type: string
    sql: {% if     param_dynamic_dim_1._parameter_value == "'SSCP_CODE'"  %} ${cust_n_ssg_grp_sts_multimth}
        ...
        {% endif %} ;; }
  dimension: dynamic_dim_pivot_2 {   type: string
    sql: {% if     param_dynamic_dim_2._parameter_value == "'SSCP_CODE'"  %} ${cust_n_ssg_grp_sts_multimth}
        ...
        {% endif %} ;; }
  dimension: dynamic_dim_pivot_3 {   type: string
    sql: {% if     param_dynamic_dim_3._parameter_value == "'SSCP_CODE'"  %} ${cust_n_ssg_grp_sts_multimth}
        ...
        {% endif %} ;; }
  dimension: fiscal_or_cal_yr {   type: string
    sql: {% if    calendar_selection._parameter_value == "'CALENDAR'"  %}
  ${TABLE}.calendar_year
        {% elsif calendar_selection._parameter_value == "'FISCAL'"  %}
  ...
  dimension: grouping_element {   type: string
  ...
  dimension: scrfa_done_vs_missing {   type: string
    sql: ${TABLE}.scrfa_done_vs_missing ;; }
  dimension: scrfa_is_cva_complete {   type: string
    sql: CASE ${TABLE}.scrfa_done_vs_missing
      WHEN 'CVA Missing' THEN 'No' WHEN 'CVA Done' THEN 'Yes' END ;; }
  dimension: service_scope_group_code {   type: string
  ...
  dimension: trade_grp { 
    ...
    type: string
    sql: ${TABLE}.trade_grp ;; }
  dimension: trade_grp_ord {   type: number
...
link: { label: "Click to download CVA data file template"
...
link: { label: "Drill to Details"
  ...
  measure: data_file_4_missing_cva_elements { 
    hidden: yes
    type: average
    filters__all: [ [ { scrfa_done_vs_missing: CVA Missing }] ] 
    sql: 1 ;;
    drill_fields: [ v_customer_opus_n_prospect.oneforce_id, of_customer.cust_grp_id, of_customer_group.cust_grp_nm, cust_cd, v_customer_opus_n_prospect.name, dummy_ckam_rhq, ckam_usr.country, dummy_ckam_country_name, ckam_usr.office_code_number, sc_rfa_no, ctrt_eff_dt_dtl, ctrt_exp_dt_dtl, ckam_usr.username, service_scope_group_code, dominant_flag_code, dummy_POR_RHQ, dummy_por_cd, dummy_por_nm, dummy_rev_lane_cd, dummy_live_reefer_flg, dummy_target_teu, dummy_origin_code, dummy_destination_code, dummy_destinantion_country_code, dummy_service_scope_code, dummy_CN_Sub_Region,]  }
  ...
  measure: grp_element_cnt {   type: count_distinct
  ...
  measure: total_target_for_mth { 
    ...
    set: general_drill_down_overall { fields: [ cust_grp_id, cust_cd, sc_rfa_no, service_scope_group_code, dominant_flag, cust_grp_sts_multimth, cust_cd_sts_multimth,]  }
    set: detail { fields: [ month, cust_grp_typ, cust_grp_id, cust_cd, sc_rfa_no, service_scope_group_code, dominant_flag, cust_grp_sts_multimth, cust_cd_sts_multimth,]  }}


view: global_cva_completion_2_1_inner {
  derived_table: { sql: WITH mths AS (
  ...
  GREATEST(tgt.CVA_Effective_Date,
  CAST( mths.month  AS DATE FORMAT 'YYYYMM')        ) , day ) + 1 ) /
  ...
  when of_ctrt_loc.Country_Code in ('HK','MO')
  then 'South China' --'SCN'
  ...
  INNER JOIN  `ONEFORCE.OF_SVC_SCP`
  sscp    ON scdtl.svc_scp_cd
  = sscp.Service_Scope_Code
  ...
  INNER JOIN  `ONEFORCE.OF_CUSTOMER_GROUP`   sccgrp ON sccust.cust_grp_id = sccgrp.cust_grp_id
       --LEFT JOIN   `ONEFORCE.OF_OFFICE`     of_ctrt_ofc  ON schdr.ofc_cd
  = of_ctrt_ofc.office_code
  LEFT JOIN   `ONEFORCE.OF_OFFICE`     of_ctrt_ofc  ON scdtl.scp_ofc_cd
  = of_ctrt_ofc.office_code -- use service scope level office for mapping
  ...
  -- AND    sc_each_mth.Dominant_Flag
  = cva_each_mth.dominant_flag
  -- matching dominant flag (DOM / N-DOM)
  AND    sc_each_mth.scp_ofc_cd
  = cva_each_mth.Contract_Office_Code      -- matching contract office code
  AND    sc_each_mth.month
  = cva_each_mth.month
  -- matching of month
  )
  ...
  ELSE ( MAX( CAST(null AS string) )
  ) END
  FROM   cva_each_mth_gka_nvo
  WHERE  sc_each_mth.customer_id
  = cva_each_mth_gka_nvo.customer_id
  AND    sc_each_mth.cust_grp_typ
  = 'NVO'
  ...
  AND    sc_each_mth.scp_ofc_cd
  = cva_each_mth_gka_nvo.Contract_Office_Code  -- matching contract office code
  AND    sc_each_mth.month
  = cva_each_mth_gka_nvo.month
  -- matching of month
  ...
  dimension: ckam_sales_person {   type: string
    sql: ${TABLE}.ckam_sales_person ;; }
  dimension: ctrt_country_cgm_logic {   type: string
    sql: ${TABLE}.ctrt_country_cgm_logic ;; }
  dimension: ctrt_ofc_code {   type: string
    sql: ${TABLE}.ctrt_ofc_code ;; }
  dimension: ctrt_period_typ {   type: string
    sql: ${TABLE}.ctrt_period_typ ;; }
  dimension: ctrt_rhq_code {   type: string
    sql: ${TABLE}.ctrt_rhq_code ;; }
  dimension: cust_cd {   type: string
    sql: ${TABLE}.cust_cd ;; }
  dimension: cust_cd_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_grp_sts ;; }
  dimension: cust_cd_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_grp_sts_4_gkanvo ;; }
  dimension: cust_cd_n_ckam_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ckam_grp_sts ;; }
  dimension: cust_cd_n_ckam_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_n_ckam_grp_sts_4_gkanvo ;; }
  dimension: cust_cd_n_ctrtctry_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtctry_grp_sts ;; }
  dimension: cust_cd_n_ctrtctry_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtctry_grp_sts_4_gkanvo ;; }
  dimension: cust_cd_n_ctrtofc_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtofc_grp_sts ;; }
  dimension: cust_cd_n_ctrtofc_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtofc_grp_sts_4_gkanvo ;; }
  dimension: cust_cd_n_ctrtrhq_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtrhq_grp_sts ;; }
  dimension: cust_cd_n_ctrtrhq_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_n_ctrtrhq_grp_sts_4_gkanvo ;; }
  dimension: cust_cd_n_dom_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_dom_grp_sts ;; }
  dimension: cust_cd_n_dom_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_n_dom_grp_sts_4_gkanvo ;; }
  dimension: cust_cd_n_nm {   type: string
    sql: ${TABLE}.cust_cd_n_nm ;; }
  dimension: cust_cd_n_period_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_period_grp_sts ;; }
  dimension: cust_cd_n_period_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_n_period_grp_sts_4_gkanvo ;; }
  dimension: cust_cd_n_sscp_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_n_sscp_grp_sts_4_gkanvo ;; }
  dimension: cust_cd_n_ssg_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_ssg_grp_sts ;; }
  dimension: cust_cd_n_ssg_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_n_ssg_grp_sts_4_gkanvo ;; }
  dimension: cust_cd_n_trd_grp_sts {   type: string
    sql: ${TABLE}.cust_cd_n_trd_grp_sts ;; }
  dimension: cust_cd_n_trd_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_cd_n_trd_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_grp_sts ;; }
  dimension: cust_grp_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_id {   type: string
    sql: ${TABLE}.cust_grp_id ;; }
  dimension: cust_grp_id_n_nm {   type: string
    sql: ${TABLE}.cust_grp_id_n_nm ;; }
  dimension: cust_grp_key_acct_tp_cd {   type: string
    sql: ${TABLE}.cust_grp_key_acct_tp_cd ;; }
  dimension: cust_grp_n_ckam_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ckam_grp_sts ;; }
  dimension: cust_grp_n_ckam_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_n_ckam_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_n_ctrtctry_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtctry_grp_sts ;; }
  dimension: cust_grp_n_ctrtctry_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtctry_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_n_ctrtofc_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtofc_grp_sts ;; }
  dimension: cust_grp_n_ctrtofc_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtofc_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_n_ctrtrhq_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtrhq_grp_sts ;; }
  dimension: cust_grp_n_ctrtrhq_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_n_ctrtrhq_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_n_dom_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_dom_grp_sts ;; }
  dimension: cust_grp_n_dom_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_n_dom_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_n_period_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_period_grp_sts ;; }
  dimension: cust_grp_n_period_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_n_period_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_n_sscp_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_n_sscp_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_n_ssg_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_ssg_grp_sts ;; }
  dimension: cust_grp_n_ssg_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_n_ssg_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_n_trd_grp_sts {   type: string
    sql: ${TABLE}.cust_grp_n_trd_grp_sts ;; }
  dimension: cust_grp_n_trd_grp_sts_4_gkanvo {   type: string
    sql: ${TABLE}.cust_grp_n_trd_grp_sts_4_gkanvo ;; }
  dimension: cust_grp_typ {   type: string
    sql: ${TABLE}.cust_grp_typ ;; }
  dimension: dominant_flag {   type: string
    sql: ${TABLE}.dominant_flag ;; }
  dimension: month {   type: string
    sql: ${TABLE}.month ;; }
  dimension: sc_rfa_no {   type: string
    sql: ${TABLE}.sc_rfa_no ;; }
  dimension: scp_ofc_cd {   type: string
    sql: ${TABLE}.scp_ofc_cd ;; }
  dimension: scrfa_done_vs_missing {   type: string
    sql: ${TABLE}.scrfa_done_vs_missing ;; }
  dimension: scrfa_done_vs_missing_4_gkanvo {   type: string
  ...
  dimension: service_scope_group_code {   type: string
    sql: ${TABLE}.service_scope_group_code ;; }
  dimension: target_for_mth {   type: string
    sql: ${TABLE}.target_for_mth ;; }
  dimension: trade_grp { 
    type: string
    order_by_field: trade_grp_ord
  ...
  measure: count {   type: count
    ...
    set: detail { fields: [ month, cust_grp_typ, cust_grp_id, cust_cd, sc_rfa_no, service_scope_group_code, dominant_flag, trade_grp, ctrt_ofc_code, ctrt_country_cgm_logic, ctrt_rhq_code, ckam_sales_person, scrfa_done_vs_missing, cust_grp_grp_sts, cust_grp_n_trd_grp_sts, cust_grp_n_ssg_grp_sts, cust_grp_n_dom_grp_sts, cust_grp_n_ctrtrhq_grp_sts, cust_grp_n_ctrtctry_grp_sts, cust_grp_n_ctrtofc_grp_sts, cust_grp_n_ckam_grp_sts, cust_cd_grp_sts, cust_cd_n_trd_grp_sts, cust_cd_n_ssg_grp_sts, cust_cd_n_dom_grp_sts, cust_cd_n_ctrtrhq_grp_sts, cust_cd_n_ctrtctry_grp_sts, cust_cd_n_ctrtofc_grp_sts, cust_cd_n_ckam_grp_sts,]  }}
